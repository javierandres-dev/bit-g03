...
(() => {
  ...
  for (const desarrollador of desarrolladores) {
    if (desarrollador.activo) {
      html += `<li class="activo">${desarrollador.nombre} <a href="${desarrollador.paginaWeb}" target="_blank" rel="noopener noreferrer">Página personal</a> <a href="${desarrollador.repositorio}" target="_blank" rel="noopener noreferrer">GitHub personal</a> <a href="${desarrollador.entregable1}" target="_blank" rel="noopener noreferrer">Sitio web</a></li>`;
    } else {
